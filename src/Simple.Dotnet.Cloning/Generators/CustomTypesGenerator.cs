...
namespace Simple.Dotnet.Cloning.Generators
{
    internal static class CustomTypesGenerator
    {
        ...
        internal static readonly MethodInfo LinkedListOpenedMethod = Cloner.GetMethod(nameof(RecurringTypesCloner.CloneLinkedList), BindingFlags.Static | BindingFlags.Public); 
        internal static readonly MethodInfo DictionaryOpenedMethod = Cloner.GetMethod(nameof(RecurringTypesCloner.CloneDictionary), BindingFlags.Static | BindingFlags.Public);
        internal static readonly MethodInfo SortedDictionaryOpenedMethod = Cloner.GetMethod(nameof(RecurringTypesCloner.CloneSortedDictionary), BindingFlags.Static | BindingFlags.Public);
